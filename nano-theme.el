...
(defun guto/nano-theme--font-lock-zenburn ()
  "Derive font-lock faces from nano-faces."
  (set-face 'font-lock-comment-face                    'nano-face-faded)
  (set-face 'font-lock-doc-face                        'nano-face-faded)
  (set-face 'font-lock-string-face                    'nano-face-popout)
...
(defun guto/nano-theme--font-lock-nord ()
  "Derive font-lock faces from nano-faces."
  ;; (set-face 'font-lock-comment-face                    'nano-face-faded)
  ;; (set-face 'font-lock-doc-face                        'nano-face-faded)
  ;; (set-face 'font-lock-string-face                    'nano-face-popout)
...
(defun guto/nano-theme-zenburn ()
  "Derive many, many faces from the core nano faces."
  (nano-theme--basics)
  ;; (nano-theme--font-lock)
  (guto/nano-theme--font-lock-zenburn) 
  (nano-theme--mode-line)
  (nano-theme--minibuffer)
  (nano-theme--buttons)
  (nano-theme--info)
...
(defun guto/nano-theme-nord ()
  "Derive many, many faces from the core nano faces."
  (nano-theme--basics)
  ;; (nano-theme--font-lock)
  (guto/nano-theme--font-lock-nord) 
  (nano-theme--mode-line)
  (nano-theme--minibuffer)
  (nano-theme--buttons)
  (nano-theme--info)
